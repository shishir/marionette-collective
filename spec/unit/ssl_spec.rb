...
module MCollective
    describe SSL do
        ...
        describe "#decrypt_with_private" do
            it "should fail if not given a IV" do
                expect {
                    @ssl.decrypt_with_private({:key => "x", :data => "x"})
                }.to raise_error("Crypted data should include a IV")
            end
        ...
        describe "#decrypt_with_public" do
            it "should fail if not given a IV" do
                expect {
                    @ssl.decrypt_with_public({:key => "x", :data => "x"})
                }.to raise_error("Crypted data should include a IV")
            end
